                ...
                <h1 className='header-index'>
                    ...
                    <div className="center-container">
                        ...
                        <button onClick={scrollToMyWork} className="btn">
                            ...
                            <span className='btn-text' >VIEW MY WORK   <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-arrow-down-circle" viewBox="0 0 16 16">
